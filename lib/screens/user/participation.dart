...
class Participation extends StatelessWidget{
  final String token;
  final Function goto;
  Participation(this.token, this.goto, {super.key});
        ...
        child: ListView(
          children: [
            Column(
              ...
              children: [
                SizedBox(height: 32,),
                Text("Participaciones en la materia", style: style),
                SizedBox(height: 32,),
                Card(
                  child: DataTable(
                    columns: const <DataColumn>[
                      ...
                      DataColumn(
                        label: Expanded(child: Text('Nota', style: TextStyle(fontStyle: FontStyle.italic))),
                      ),
                      DataColumn(
                        label: Expanded(child: Text('Descripción', style: TextStyle(fontStyle: FontStyle.italic))),
                      ),
                    ],
                    rows: const <DataRow>[
                      DataRow(
                        cells: <DataCell>[
                          ...
                          DataCell(Text('87')),
                          DataCell(Text('Comentario sobre logaritmos.')),
                        ],
                      ),
                    ],
                  ),
